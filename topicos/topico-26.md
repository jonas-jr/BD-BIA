...
Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-1-bia, com o título "Tópico 26", para responder: 
...
1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2021-1-bia, cujo título é "Tópico 26", para indicar suas reflexões iniciais sobre *generalização/especialização no Modelo Entidade Relacionamento (MER)*.
