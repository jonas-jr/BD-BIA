...
|PESSOAJURIDICA (CodPes, CGC, RazaoSocial, NomeFantasia)<br>PESSOAJURIDICA (CodPes) IS PRIMARY KEY<br>PESSOAJURIDICA (CodCli) REFERENCES PESSOA (PesCli)|
...
Crie o diretório **topico-31** no seu repositório https://github.com/nomealuno/bd-2021-1-bia, onde **nomealuno** é o nome da conta do aluno no Github. Este é o repositório que você criou no início da disciplina.
